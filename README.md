<!-- migrate-repo:banner -->
> [!IMPORTANT]
> **This repository has moved to [`schubergphilis-ep/terraform-azure-mcaf-monitoring`](https://github.com/schubergphilis-ep/terraform-azure-mcaf-monitoring).**
...
| <a name="input_tenant_id"></a> [tenant\_id](#input\_tenant\_id) | The tenant ID of the Azure subscription. | `string` | `null` | no |
